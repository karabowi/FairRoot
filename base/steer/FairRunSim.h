...
class FairRunSim : public FairRun
{
  public:
    ...
    */
    ...
    void SetSimulationConfig(FairSimulationConfig* tconf) { fSimulationConfig = tconf; }
    FairSimulationConfig* GetSimulationConfig()           { return fSimulationConfig;  }
 ...
 private:
  ...
  protected:
    ...
    FairSimulationConfig*  fSimulationConfig;  //!                 /** Simulation configuration */
