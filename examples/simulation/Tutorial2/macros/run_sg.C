void run_sg(Int_t nEvents = 10)
{
  ...
  // Output file name
  TString outFile = Form("%s/tutorial2_%s.mc_p%1.3f_t%1.0f_n%d.sg.root",
			 outDir.Data(),
  ...
  // Parameter file name
  TString parFile = Form("%s/tutorial2_%s.params_p%1.3f_t%1.0f_n%d.sg.root",
			 outDir.Data(),
			 partName[chosenPart].Data(),
			 momentum,
			 theta,
