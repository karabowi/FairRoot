...
int TTree_runMC(Int_t nEvents = 10, TString mcEngine = "TGeant4", Bool_t isMT = false)
{
    ...
    // Output file name
    TString outFile = Form("%s/ttree_prop.mc.root", outDir.Data());

    // Parameter file name
    TString parFile = Form("%s/ttree_prop.par.root", outDir.Data());

    TString geoFile = "geofile_" + mcEngine + "_ttree.root";
