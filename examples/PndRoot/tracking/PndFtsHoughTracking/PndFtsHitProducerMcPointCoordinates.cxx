...
PndFtsHitProducerMcPointCoordinates::PndFtsHitProducerMcPointCoordinates()
  : FairTask("Ideal FTS Hit Producer", 0), fPointArray(nullptr), fHitArray(nullptr), fVolumeArray(0), fHitInfoArray(nullptr), fevtn(0), fFtsParameters(new PndGeoFtsPar()),
    fPersistence(kTRUE)
{
}
// -------------------------------------------------------------------------
...
InitStatus PndFtsHitProducerMcPointCoordinates::Init()
{
  ...
  LOG(info) << " PndFtsHitProducerMcPointCoordinates: INITIALIZATION SUCCESSFUL";
...
// -------------------------------------------------------------------------
void PndFtsHitProducerMcPointCoordinates::FoldZPosWithResolution(Double_t &zpos, Double_t &zposError, TVector3,
                                                                 TVector3) // localInPos localOutPos //[R.K.03/2017] unused variable(s)
{
...
PndFtsHit *PndFtsHitProducerMcPointCoordinates::AddHit(Int_t detID, Int_t tubeID, Int_t chamberID, Int_t layerID, Int_t skew, Int_t iPoint, TVector3 &pos, TVector3 &dpos,
                                                       Double_t p, Double_t rsim, Double_t closestDistanceError, Double_t depcharge)
{
