...
template <typename T>
static inline void BinaryStoreWrite(const T *mem, int count, FILE *f)
{
...
template <typename T>
static inline void BinaryStoreWrite(const T &mem, FILE *f)
{
...
template <typename T>
static inline void BinaryStoreRead(T *mem, int count, FILE *f)
{
