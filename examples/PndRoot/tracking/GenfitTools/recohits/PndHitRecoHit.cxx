...
PndHitRecoHit::PndHitRecoHit() : GFRecoHitIfc<GFSpacepointHitPolicy>(fNparHitRep) {}

PndHitRecoHit::PndHitRecoHit(FairMCPoint *point) : GFRecoHitIfc<GFSpacepointHitPolicy>(fNparHitRep)
{
...
PndHitRecoHit::PndHitRecoHit(FairHit *hit) : GFRecoHitIfc<GFSpacepointHitPolicy>(fNparHitRep)
{
...
Double_t PndHitRecoHit::residualScalar(GFAbsTrackRep * /*stateVector*/, const TMatrixT<Double_t> & /*state*/)
{
