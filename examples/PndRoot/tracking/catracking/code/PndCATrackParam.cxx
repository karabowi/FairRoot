...
void PndCATrackParam::GetDCAPoint(float x, float y, float z, float &xp, float &yp, float &zp, float Bz) const
{
...
float PndCATrackParam::BetheBlochGeant(float bg2, float kp0, float kp1, float kp2, float kp3, float kp4)
{
  //
