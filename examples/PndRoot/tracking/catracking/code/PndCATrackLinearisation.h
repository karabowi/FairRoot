...
class PndCATrackLinearisation {
 public:
  PndCATrackLinearisation() : fSinPhi(0), fCosPhi(1), fDzDs(0), fQPt(0) {}

  PndCATrackLinearisation(float SinPhi1, float CosPhi1, float DzDs1, float QPt1) : fSinPhi(SinPhi1), fCosPhi(CosPhi1), fDzDs(DzDs1), fQPt(QPt1) {}
...
inline PndCATrackLinearisation::PndCATrackLinearisation(const PndCATrackParam &t)
  : fSinPhi(CAMath::Min(.999f, CAMath::Max(-.999f, t.SinPhi()))), fCosPhi(t.SignCosPhi() * CAMath::Sqrt(1.f - fSinPhi * fSinPhi)), fDzDs(t.DzDs()), fQPt(t.QPt())
{
}

inline void PndCATrackLinearisation::Set(float SinPhi1, float CosPhi1, float DzDs1, float QPt1)
{
  SetSinPhi(SinPhi1);
  SetCosPhi(CosPhi1);
  SetDzDs(DzDs1);
