...
PndFileNameCreator::PndFileNameCreator()
  : fFileName(), fExtPar("par"), fExtSim("sim"), fExtDigi("digi"), fExtReco("reco"), fExtPid("pid"), fExtTrackF("trackF"), fExtIdealTrackF("idealTrackF"), fExtRiemann("riemann"),
    fExtCombinedRiemann("combRiemann"), fExtKalman("kalman"), fExtVertex("vertex"), fVerbose(0)
{
}

PndFileNameCreator::PndFileNameCreator(std::string fileName)
  : fFileName(fileName), fExtPar("par"), fExtSim("sim"), fExtDigi("digi"), fExtReco("reco"), fExtPid("pid"), fExtTrackF("trackF"), fExtIdealTrackF("idealTrackF"),
    fExtRiemann("riemann"), fExtCombinedRiemann("combRiemann"), fExtKalman("kalman"), fExtVertex("vertex"), fVerbose(0)
{
...
std::string PndFileNameCreator::GetCustomFileName(std::string ext, std::string addon, bool cut)
{
  ...
  result += ".root";
  if (fVerbose > 0)
    std::cout << " -I- PndFileNameCreator file: " << result.c_str() << std::endl;
  return result;
}
...
std::string PndFileNameCreator::GetCustomFileNameInitial(std::string ext)
{
  ...
  if (fVerbose > 0)
    std::cout << " -I- PndFileNameCreator::GetCustomFileNameInitial: " << result.c_str() << std::endl;
  return result;
}
