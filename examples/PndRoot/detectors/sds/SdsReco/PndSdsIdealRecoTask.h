...
class PndSdsIdealRecoTask : public PndSdsTask {
 public:
  ...
  PndSdsIdealRecoTask(PndSdsIdealRecoTask &other)
    : PndSdsTask(), fGeoH(other.fGeoH), fPointArray(other.fPointArray), fMctruthArray(other.fMctruthArray), fHitOutputArray(other.fHitOutputArray), fSigmaX(other.fSigmaX),
      fSigmaY(other.fSigmaY), fSigmaZ(other.fSigmaZ), fCurrentPndSdsMCPoint(other.fCurrentPndSdsMCPoint), fCurrentTransMat(other.fCurrentTransMat),
