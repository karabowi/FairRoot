...
class PndSdsIdealClusterTask : public PndSdsTask {
 public:
  ...
  PndSdsIdealClusterTask(PndSdsIdealClusterTask &other)
    : PndSdsTask(), fDigiArray(other.fDigiArray), fClustBranchName(other.fClustBranchName), fClusterType(other.fClusterType), fClusterArray(other.fClusterArray),
      fHitArray(other.fHitArray), fGeoH(other.fGeoH), fRadius(other.fRadius), fFEcolumns(other.fFEcolumns), fFErows(other.fFErows), fGeoFile(other.fGeoFile), finder(other.finder),
