...
class PndSdsPixelClusterTask : public PndSdsTask {
 public:
  ...
  PndSdsPixelClusterTask(const PndSdsPixelClusterTask &other)
    : PndSdsTask(), fUseNoiseSuppression(other.fUseNoiseSuppression), fFEModel(other.fFEModel), fDigiArray(other.fDigiArray), fDigiPar(other.fDigiPar),
      fChargeConverter(other.fChargeConverter), fGeoH(other.fGeoH), fClustBranchName(other.fClustBranchName), fClusterArray(other.fClusterArray), fHitArray(other.fHitArray),
      fEventHeader(other.fEventHeader), fFunctor(other.fFunctor), fStartFunctor(other.fStartFunctor), fClusterType(other.fClusterType), fEventNr(other.fEventNr),
      fClusterFinder(other.fClusterFinder), fBackMapping(other.fBackMapping){};
  /** Named constructor **/
