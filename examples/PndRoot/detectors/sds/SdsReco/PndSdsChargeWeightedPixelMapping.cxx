...
PndSdsChargeWeightedPixelMapping::PndSdsChargeWeightedPixelMapping() : PndSdsPixelBackMapping(), fChargeConverter(nullptr), flx(0.), fly(0.), fcols(0), frows(0) {}
PndSdsChargeWeightedPixelMapping::PndSdsChargeWeightedPixelMapping(PndGeoHandling *geo)
  : PndSdsPixelBackMapping(geo), fChargeConverter(nullptr), flx(0.), fly(0.), fcols(0), frows(0)
{
}
