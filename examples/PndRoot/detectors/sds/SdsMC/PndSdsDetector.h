...
class PndSdsDetector : public FairDetector {
 ...
 public:
  ...
  PndSdsDetector(PndSdsDetector &other)
    : FairDetector(other), fPersistance(other.fPersistance), fTrackID(other.fTrackID), fVolumeID(other.fVolumeID), fPosIn(other.fPosIn), fPosOut(other.fPosOut),
      fMomIn(other.fMomIn), fMomOut(other.fMomOut), fTime(other.fTime), fLength(other.fLength), fELoss(other.fELoss), fGeoH(other.fGeoH), fPosIndex(other.fPosIndex),
      fUseRadDamOption(other.fUseRadDamOption), fOutBranchName(other.fOutBranchName), fFolderName(other.fFolderName),
      fDetectorID(other.fDetectorID), fListOfSensitives(other.fListOfSensitives){};
  ...
  void SetDetectorID(PndDetectorId id)
  {
    fDetectorID = id;
    fDetId = static_cast<int>(id);
  }
 ...
 protected:
  ...
  Int_t fPosIndex;                 //!
    std::vector<PndSdsMCPoint>* fPointVector{new std::vector<PndSdsMCPoint>};
  ...
  PndDetectorId fDetectorID;          //! To be set by daughter classes
   ...
   **/
  void 
  AddHit(Int_t trackID, Int_t detID, Int_t sensorID, TVector3 posIn, TVector3 posOut, TVector3 momIn, TVector3 momOut, Double_t time, Double_t length, Double_t eLoss);
  ...
  void ResetParameters();
    ...
    PndSdsDetector(const PndSdsDetector&);
    PndSdsDetector& operator=(const PndSdsDetector&);
