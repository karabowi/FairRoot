...
PndSdsDigiPixelWriteoutBuffer::PndSdsDigiPixelWriteoutBuffer() : FairWriteoutBuffer(), fData_map()
{

  // TODO Auto-generated constructor stub
}

PndSdsDigiPixelWriteoutBuffer::PndSdsDigiPixelWriteoutBuffer(TString branchName, TString folderName, Bool_t persistance)
  : FairWriteoutBuffer(branchName, "PndSdsDigiPixel", folderName, persistance), fData_map()
{
}
...
void PndSdsDigiPixelWriteoutBuffer::AddNewDataToTClonesArray(FairTimeStamp *data)
{
  ...
  if (fVerbose > 1)
    std::cout << "Data Inserted: " << *(PndSdsDigiPixel *)(data) << std::endl;
