...
PndSdsCalcFePixel::PndSdsCalcFePixel() : fNcols(1), fNrows(1), fMaxFEperCol(1), fMaxFEperRow(1) {}

PndSdsCalcFePixel::PndSdsCalcFePixel(const PndSdsPixelDigiPar &digi_par)
  : fNcols(digi_par.GetFECols()), fNrows(digi_par.GetFERows()), fMaxFEperCol(digi_par.GetMaxFEperCol()), fMaxFEperRow(digi_par.GetMaxFEperRow())
{
}
