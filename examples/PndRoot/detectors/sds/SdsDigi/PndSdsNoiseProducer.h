...
class PndSdsNoiseProducer : public PndSdsTask {
 public:
  ...
  PndSdsNoiseProducer(PndSdsNoiseProducer &other)
    : PndSdsTask(), fBranchNameStrip(other.fBranchNameStrip), fBranchNamePixel(other.fBranchNamePixel), fDigiStripArray(other.fDigiStripArray),
      fDigiPixelArray(other.fDigiPixelArray), fDigiParRect(other.fDigiParRect), fDigiParTrap(other.fDigiParTrap), fDigiParPix(other.fDigiParPix), fMCPointType(other.fMCPointType),
      fGeoH(other.fGeoH), fPixelIds4(other.fPixelIds4), fPixelIds6(other.fPixelIds6), fPixelIds8(other.fPixelIds8), fPixelIds12(other.fPixelIds12),
      fStripRectIds(other.fStripRectIds), fStripTrapIds(other.fStripTrapIds), fNoiseSpread(other.fNoiseSpread), fThreshold(other.fThreshold),
