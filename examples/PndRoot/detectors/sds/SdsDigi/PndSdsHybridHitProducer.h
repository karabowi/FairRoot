...
class PndSdsHybridHitProducer : public PndSdsTask {
 public:
  ...
  PndSdsHybridHitProducer(PndSdsHybridHitProducer &other)
    : PndSdsTask(), fDigiPixelMCInfo(other.fDigiPixelMCInfo), fPointArray(other.fPointArray), fPixelArray(other.fPixelArray), fPixelMCArray(other.fPixelMCArray),
      fDigiPar(other.fDigiPar), fTotDigiPar(other.fTotDigiPar), fChargeConverter(other.fChargeConverter), fMCEventHeader(other.fMCEventHeader), fDataBuffer(other.fDataBuffer),
      flx(other.flx), fly(other.fly), fthreshold(other.fthreshold), fnoise(other.fnoise), fqsigma(other.fqsigma), fcols(other.fcols), frows(other.frows),
      fPixelHits(other.fPixelHits), fGeoH(other.fGeoH), fEventNr(other.fEventNr), fOverwriteParams(other.fOverwriteParams), fTimeOrderedDigi(other.fTimeOrderedDigi),
