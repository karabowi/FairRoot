...
PndSdsAdcChargeConversion::PndSdsAdcChargeConversion(Int_t threshold, Int_t adcstep, Int_t resolution, Int_t VerboseLevel)
  : PndSdsChargeConversion(kADC), fVerboseLevel(VerboseLevel), fThreshold(threshold), fAdcStep(adcstep), fResolution(resolution), fMaxADC(0), fTimeStep(0.)
{
