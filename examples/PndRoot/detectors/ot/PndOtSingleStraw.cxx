...
////////////////////////////////////////////////////////////////////////////
// PndOtSingleStraw source file
//
// Copied from PndFtsSingleStraw
//
...
//
//
// For other applications see the routines listed in PndOtSingleStraw.h
//
...
ClassImp(PndOtSingleStraw);

// ============================================================
PndOtSingleStraw::PndOtSingleStraw()
...
// ----------------------------------------------------------------------
void PndOtSingleStraw::TConst(Double_t R1, Double_t P1, Double_t A1, Double_t C1)
{
...
// ==============================================================
void PndOtSingleStraw::PutWireXYZ(Double_t w1, Double_t w2, Double_t w3, Double_t w4, Double_t w5, Double_t w6)
{
...
void PndOtSingleStraw::TInit(Double_t xPMass, Double_t xPMom, Double_t InOut[])
{
...
// energy loss in GeV
Double_t PndOtSingleStraw::STEloss()
{
...
Double_t PndOtSingleStraw::STUrban()
{
...
Double_t PndOtSingleStraw::StrawCharge()
{
...
Int_t PndOtSingleStraw::Cluster()
{
...
Double_t PndOtSingleStraw::RRise(Double_t gamma2)
{
...
void PndOtSingleStraw::Polya(Double_t bpar)
{
...
Double_t PndOtSingleStraw::PolyaSamp()
{
...
TVector3 PndOtSingleStraw::WDistCalc(Double_t DisTot)
{
...
Int_t PndOtSingleStraw::TimeEle()
{
...
Double_t PndOtSingleStraw::Signal(Double_t t, Double_t t0)
{
...
Int_t PndOtSingleStraw::StrawSignal(Int_t nsteps)
{
...
Int_t PndOtSingleStraw::StrawTime()
{
...
Double_t PndOtSingleStraw::TrueDist(Double_t Point[])
{
...
Double_t PndOtSingleStraw::TimnsToDiscm(Double_t time)
{
...
Double_t PndOtSingleStraw::PartToTime(Double_t xPMass, Double_t xPMom, Double_t InOut[])
{
...
// --------------------------------------------------------------------------------
Double_t PndOtSingleStraw::PartToADC()
{
...
Double_t PndOtSingleStraw::FastPartToADC()
{
...
// ----------------------------------------------------------------------------------
Double_t PndOtSingleStraw::FastRec(Double_t TrueDcm, Int_t Flag)
{
...
// --------------------------------------------------------------------------------
Double_t PndOtSingleStraw::DiffLong(Double_t Distcm)
{
...
// --------------------------------------------------------------------------------
Double_t PndOtSingleStraw::DiffTran(Double_t Distcm)
{
...
// --------------------------------------------------------
Double_t PndOtSingleStraw::DistEle(Double_t time)
{
