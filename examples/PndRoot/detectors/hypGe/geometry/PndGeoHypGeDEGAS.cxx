...
PndGeoHypGeDEGAS::PndGeoHypGeDEGAS(TGeoMedium *ExtGe, TGeoMedium *ExtAl, Int_t ExtClusterNumber)
{
  ...
  Filename += "/detectors/hypGe/geometry/PndGeoHypGeDEGASParfile.txt";
...
void PndGeoHypGeDEGAS::BuildCryostat()
{
  ...
  CryostatUpperTranslation =
    new TGeoTranslation("CryostatTripleUpperTranslation", 0, 0, CryostatFrontThickness + CryostatLowerArb8Heigt + CryostatMiddleArb8Heigt + CryostatUpperArb8Heigt / 2);
