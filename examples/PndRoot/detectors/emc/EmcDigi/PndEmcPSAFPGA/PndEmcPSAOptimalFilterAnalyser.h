...
#ifndef PNDEMCOPTIMALFILTERANALYSER_HH
#define PNDEMCOPTIMALFILTERANALYSER_HH
...
class PndEmcPSAOptimalFilterAnalyser : public PndEmcAbsPSA {

public:
  PndEmcPSAOptimalFilterAnalyser(Double_t cf_frac, Double_t cf_tap, const Double_t* cf_tcorr, Int_t cf_n, 
  const Double_t* of_a, const Double_t* of_b, Int_t of_m, Int_t of_b0, PndEmcAbsPulseshape* shape, Double_t threshold, Double_t baseline = 0., Int_t verbose = 1);
...
private:
  ...
  ClassDef(PndEmcPSAOptimalFilterAnalyser, 1);
};
