...
void PndLmdIdealFitTask::Exec(Option_t *)
{
  ...
  for (Int_t track = 0; track < ntcand; track++) {
    ...
    PndLinTrack *trackfit =
      new PndLinTrack("Lumi", truePos.X(), trueTrack.X() / trueTrack.Z(), truePos.Y(), trueTrack.Y() / trueTrack.Z(), truePos.Z(), trueTrack.Z(), 0, fhit, lhit, track);
