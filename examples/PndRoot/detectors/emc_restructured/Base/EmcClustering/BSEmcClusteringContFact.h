 ...
 * @ingroup EmcBase
 */
class BSEmcClusteringContFact : public FairContFact {
 private:
 ...
 public:
  ...
  ClassDef(BSEmcClusteringContFact, 0) // Factory for all EMC parameter containers
};

#endif /*BSEMCCLUSTERINGCONTFACT_HH*/
