...
//------------------------------------------------------------------------
//#pragma once
#ifndef BSEMCLOCALMAXFINDINGPROCESS_HH
#define BSEMCLOCALMAXFINDINGPROCESS_HH
#include <string>
#include <vector>
 ...
 * @brief Process to find all local maxima within a cluster
 * @details To be run after BSEmcClusteringProcess to determine maxima, since Subclustering depends on maxima
 ...
 * @ingroup EmcBase
 */
class BSEmcLocalMaxFindingProcess : public PndProcess {
 public:
 ...
 private:
  ...
  ClassDef(BSEmcLocalMaxFindingProcess, 1);
};

#endif /*BSEMCLOCALMAXFINDINGPROCESS_HH*/
