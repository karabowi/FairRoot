...
//#pragma once
#ifndef BSEMCSHASHLYKDIGIPAR_H
#define BSEMCSHASHLYKDIGIPAR_H
 ...
 * @ingroup PndEmc
 */
class BSEmcShashlykDigiPar : public FairParGenericSet {
 public:
...
private :
  ...
  ClassDef(BSEmcShashlykDigiPar, 0)
};

#endif /*BSEMCSHASHLYKDIGIPAR_H*/
