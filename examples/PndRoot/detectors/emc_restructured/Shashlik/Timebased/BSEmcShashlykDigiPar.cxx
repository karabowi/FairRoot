...
const std::string BSEmcShashlykDigiPar::fgParameterName = "EmcShashlykDigiPar";

BSEmcShashlykDigiPar::BSEmcShashlykDigiPar(const char *name, const char *title, const char *context) : FairParGenericSet(name, title, context)
{
