...
BSEmcShashlykNoiseAdder::BSEmcShashlykNoiseAdder(Double_t sigma, Int_t seed)
{
    fSigma = sigma;
...
void BSEmcShashlykNoiseAdder::Modify(BSEmcWaveform *wf)
{
  get_rnd_noise(wf, fSigma);
}

void BSEmcShashlykNoiseAdder::get_rnd_noise(BSEmcWaveform *wf, Double_t noise_width)
{
