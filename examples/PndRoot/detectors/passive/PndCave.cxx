...
ClassImp(PndCave) void PndCave::ConstructGeometry()
{
...
PndCave::~PndCave() {}
PndCave::PndCave(const char *name, const char *Title) : FairModule(name, Title)
{
  world[0] = 0;
  world[1] = 0;
  world[2] = 0;
...
FairModule* PndCave::CloneModule() const { return new PndCave(*this); }
