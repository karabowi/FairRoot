...
PndPipe::PndPipe(const char *name, const char *title) : FairModule(name, title) {}
...
void PndPipe::ConstructGeometry()
{
  ...
  if (fileName.EndsWith(".root")) {
    ...
    Double_t parPipeCentral[12] = {0., 360., 3, -32., 0., 8., -2., 0., .9, 23., 0., .9};

    Double_t parPipeRight[18] = {0., 360., 5, 23., .8873, .9, 25., 2.073, 2.1, 120., 2.05, 2.1, 300.1, 2.85, 2.9, 1050., 5.4, 5.5};

    Double_t parPipeVacuumLeft[9] = {0., 360., 2, -200., 0., 7.9, -32., 0., 7.9};

    Double_t parPipeVacuumCentral[12] = {0., 360., 3, -32., 0., 7.9, -2., 0., .873, 23., 0., .873};

    Double_t parPipeVacuumRight[18] = {0., 360., 5, 23., 0., .873, 25., 0., 2.073, 120., 0., 2.05, 300.1, 0., 2.85, 1050., 0., 5.4};

    Double_t parPipeTargetDown[27] = {
      0., 360., 8, -215., 17.4, 17.5, -183., 17.4, 17.5, -173., 4.5, 4.6, -96., 4.5, 4.6, -95., 2.4, 2.5, -55., 2.4, 2.5, -54., 2.056, 2.1, -15., 1.067, 1.1,
    };
    ...
    Double_t parPipeTargetUp[27] = {0., 360., 8, 15., 1.067, 1.1, 54., 2.056, 2.1, 55., 2.4, 2.5, 95., 2.4, 2.5, 96., 4.5, 4.6, 145., 4.5, 4.6, 155., 14.4, 14.5, 215., 14.4, 14.5};

    Double_t parPipeVacuumTargetDown[27] = {0.,  360., 8,  -215., 0.,   17.4, -183., 0.,   17.4, -173., 0.,   4.5, -96., 0.,
                                            4.5, -95., 0., 2.4,   -55., 0.,   2.4,   -54., 0.,   2.056, -15., 0.,  1.067};

    Double_t parPipeVacuumTargetCentral[9] = {
      0., 360., 2, -15., 0., 1.067, 15., 0., 1.067,
    };

    Double_t parPipeVacuumTargetUp[27] = {0., 360., 8, 15., 0., 1.067, 54., 0., 2.056, 55., 0., 2.4, 95., 0., 2.4, 96., 0., 4.5, 145., 0., 4.5, 155., 0., 14.4, 215., 0., 14.4};
...
FairModule* PndPipe::CloneModule() const { return new PndPipe(*this); }
