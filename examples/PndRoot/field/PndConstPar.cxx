...
// ------   Constructor   --------------------------------------------------
PndConstPar::PndConstPar(const char *name, const char *title, const char *context) : PndMapPar(name, title, context), fBx(0), fBy(0), fBz(0)
{
  fType = 0;
}

PndConstPar::PndConstPar() : PndMapPar(), fBx(0), fBy(0), fBz(0)
{
  fType = 0;
}
