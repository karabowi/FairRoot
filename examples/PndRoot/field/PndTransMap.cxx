...
using namespace std;
// -------------   Default constructor  ----------------------------------
PndTransMap::PndTransMap() : PndFieldMap(), fHemiX(0), fHemiY(0), fBeamMom(0.)
{
  fType = 4;
}
// ------------------------------------------------------------------------
...
PndTransMap::PndTransMap(const char *mapName, const char *fileType, Double_t BeamMom) : PndFieldMap(mapName, fileType), fHemiX(0), fHemiY(0), fBeamMom(BeamMom)
{
  fType = 4;
  TString Suffix = "";
...
PndTransMap::PndTransMap(PndTransPar *fieldPar) : PndFieldMap(), fHemiX(0), fHemiY(0), fBeamMom(0)
{
  fType = 4;
  fPosX = fPosY = fPosZ = 0.;
  fXmin = fYmin = fZmin = 0.;
  ...
  fBx = fBy = fBz = nullptr;
  if (!fieldPar) {
    cerr << "-W- PndTransMap::PndTransMap: empty parameter container!" << endl;
    fName = "";
    fFileName = "";
    fType = 1;
  } else {
...
Bool_t PndTransMap::IsInside(Double_t x, Double_t y, Double_t z, Int_t &ix, Int_t &iy, Int_t &iz, Double_t &dx, Double_t &dy, Double_t &dz)
{
