...
PndFieldCreator::PndFieldCreator() : FairFieldFactory(), fFieldPar(nullptr), fSPar(nullptr), fDPar(nullptr), fTPar(nullptr), fCPar(nullptr), fMPar(nullptr)
...
PndFieldCreator::PndFieldCreator(const PndFieldCreator &L)
  : FairFieldFactory(), fFieldPar(L.fFieldPar), fSPar(L.fSPar), fDPar(L.fDPar), fTPar(L.fTPar), fCPar(L.fCPar), fMPar(L.fMPar)
