...
// ------   Constructor   --------------------------------------------------
PndFieldPar::PndFieldPar(const char *name, const char *title, const char *context)
  : FairParGenericSet(name, title, context), fType(-1), fXmin(0), fXmax(0), fYmin(0), fYmax(0), fZmin(0), fZmax(0), fBx(0), fBy(0), fBz(0), fMapName(TString("")), fPosX(0),
    fPosY(0), fPosZ(0), fScale(0)
...
PndFieldPar::PndFieldPar()
  : fType(-1), fXmin(0), fXmax(0), fYmin(0), fYmax(0), fZmin(0), fZmax(0), fBx(0), fBy(0), fBz(0), fMapName(TString("")), fPosX(0), fPosY(0), fPosZ(0), fScale(0)
{
}
// -------------------------------------------------------------------------
...
void PndFieldPar::SetParameters(FairField *field)
{
  ...
  if (fType == 0) { // constant field
    ...
    cerr << "-W- PndFieldPar::SetParameters: Unknown field type " << fType << "!" << endl;
    fBx = fBy = fBz = 0.;
    fXmin = fXmax = fYmin = fYmax = fZmin = fZmax = 0.;
    fMapName = "";
    fPosX = fPosY = fPosZ = fScale = 0.;
