...
class PndSdsDigiPixel : public PndSdsDigi {
  ...
  {
    out << "PndSdsDigiPixel in: " << digi.GetSensorID() << " FE: " << digi.GetFE() << " Col/Row " << digi.GetPixelColumn() << "/" << digi.GetPixelRow() << " charge "
        << digi.GetCharge() << " e"
 ...
 public:
  ...
  virtual bool operator<(const PndSdsDigiPixel &myDigi) const
  {
    ...
    if (fCol < myDigi.GetPixelColumn())
      return true;
    else if (fCol > myDigi.GetPixelColumn())
      return false;
    if (fRow < myDigi.GetPixelRow())
      return true;
    else if (fRow > myDigi.GetPixelRow())
      return false;
    return false;
  }
