...
// -----   Default constructor   -------------------------------------------
PndSdsHit::PndSdsHit() : FairHit(), fSensorID(-1), fCharge(0), fNDigiHits(0), fClusterIndex(-1), fBotIndex(-1), fCov(3, 3) {}
// -------------------------------------------------------------------------

// -----   Standard constructor   ------------------------------------------
PndSdsHit::PndSdsHit(Int_t detID, Int_t sensorID, TVector3 &pos, TVector3 &dpos, Int_t clindex, Double_t charge, Int_t NDigiHits, Int_t mcindex)
  : FairHit(detID, pos, dpos, mcindex), fSensorID(sensorID), fCharge(charge), fNDigiHits(NDigiHits), fClusterIndex(clindex), fBotIndex(-1), fCov(3, 3)
{
}
