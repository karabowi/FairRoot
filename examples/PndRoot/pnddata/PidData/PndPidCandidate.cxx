...
PndPidCandidate::PndPidCandidate()
  : fLocked(kFALSE), fCharge(0), fXposition(0.), fYposition(0.), fZposition(0.), fXmomentum(0.), fYmomentum(0.), fZmomentum(0.), fEnergy(0.), fFirstHitX(0.), fFirstHitY(0.),
    fFirstHitZ(0.), fLastHitX(0.), fLastHitY(0.), fLastHitZ(0.), fMcIndex(-1), fTrackIndex(-1), fTrackBranch(-1), fMvdDEDX(0.), fMvdHits(0), fSttMeanDEDX(0.), fSttHits(0),
    fGemHits(0), fTofStopTime(0.), fTofM2(0.), fTofTrackLength(0.), fTofQuality(-1.), fTofIndex(-1), fDrcThetaC(0.), fDrcThetaCErr(0.), fDrcQuality(-1.), fDrcNumberOfPhotons(0),
    fDrcIndex(-1), fDiscThetaC(0.), fDiscThetaCErr(0.), fDiscQuality(-1.), fDiscNumberOfPhotons(0), fDiscIndex(-1), fRichThetaC(0.), fRichThetaCErr(0.), fRichQuality(-1.),
    fRichNumberOfPhotons(0), fRichIndex(-1), fEmcRawEnergy(0.), fEmcCalEnergy(0.), fEmcQuality(-1.), fEmcTimeStamp(0.), fEmcNumberOfCrystals(0), fEmcNumberOfBumps(0),
    fEmcModule(-1), fEmcIndex(-1), fEmcZ20(0.), fEmcZ53(0.), fEmcLat(0.), fEmcE1(0.), fEmcE9(0.), fEmcE25(0.), fMuoNumberOfLayers(0), fMuoProbability(0.), fMuoQuality(-1.),
    fMuoIron(0.), fMuoMomentumIn(0.), fMuoModule(0), fMuoHits(0), fMuoIndex(-1), fDegreesOfFreedom(0), fFitStatus(-1), fChiSquared(0.), fPidHyp(0)
...
void PndPidCandidate::PrintOn(std::ostream &o) const
{
  ...
  if (GetCharge() != 0) {
    o << " ======= Track Quality ======= "
      << "\n Fit quality         : Ndof " << GetDegreesOfFreedom() << " chi2 " << GetChiSquared() << endl; //"\n track length        : " << GetTrackLength()<<endl;
  }
}
