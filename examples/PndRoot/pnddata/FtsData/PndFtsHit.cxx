...
#include "TMath.h"
/** Default constructor **/
PndFtsHit::PndFtsHit() : fIsochrone(0.), fIsochroneError(0.), fPulse(0.), fDepCharge(0.), fTubeID(0), fChamberID(0), fLayerID(0), fSkewed(0)
{
  // Clear();
}

PndFtsHit::PndFtsHit(Int_t detID, Int_t tubeID, Int_t chamberID, Int_t layerID, Int_t skew, Int_t mcindex, TVector3 &pos, TVector3 &dpos, Double_t p, Double_t isochrone,
