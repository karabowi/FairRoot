...
class PndMCTrack : public TObject {
  ...
  */
  ...
  Int_t GetNPoints(PndDetectorId detId) const;
  /**  Modifiers  **/
  ...
  */
  ...
  void SetNPoints(PndDetectorId iDet, Int_t np);

  TLorentzVector Get4Momentum() const;

  UInt_t GetProcessID() const { return fProcess; }
 ...
 private:
  ...
  UInt_t fProcess{}; // should actually be a TMCProcess, but as we abuse the TObject::fUniqueId to store the ProcessID causing the track ...
  ClassDef(PndMCTrack, 2);
};
